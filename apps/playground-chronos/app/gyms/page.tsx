...
const PAGES = [
  { name: "Dendrite Observatory", href: "/gyms/dendrite", desc: "Interactive 2D flow visualization of the CHRONOS pipeline" },
];
...
export default function GymsPage() {
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "1rem", marginTop: "1.5rem", marginBottom: "1.5rem" }}>
        {PAGES.map((p) => (
          <Link
            key={p.href}
            href={p.href}

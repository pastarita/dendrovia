...
export const metadata: Metadata = {
  title: "CHRONOS Playground",
  description: "The Chronicler — Git History + AST Parsing playground",
};
        ...
        <div style={{ display: "flex", minHeight: "100vh" }}>
          ...
          >
            <a href="/" style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "1.25rem", fontWeight: 700 }}>
              <PillarIcon pillar="CHRONOS" size={24} />
              <span style={{ color: "var(--pillar-accent)" }}>CHRONOS</span>
            </a>
            <div style={{ fontSize: "0.75rem", opacity: 0.5 }}>:3012 · Amber</div>

            <DomainNav currentPillar="CHRONOS" />

            <PillarNav currentPillar="CHRONOS" />
          </nav>

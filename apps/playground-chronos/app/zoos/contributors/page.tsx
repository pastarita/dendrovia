        ...
        {contributors.map((c) => (
          ...
          >
            ...
            <div style={{ marginTop: '0.5rem' }}>
              <div style={{ fontSize: '0.7rem', textTransform: 'uppercase', opacity: 0.4, marginBottom: '0.4rem' }}>
                Facets
              </div>
              {Object.entries(c.facets).map(([facet, value]) => (
                ...
                >
                  ...
                  <div
                    style={{ flex: 1, height: '6px', background: '#1a1a1a', borderRadius: '3px', overflow: 'hidden' }}
                  >
                    <div
                      style={{
                        width: `${value}%`,
                  ...
                  <span style={{ width: '30px', fontSize: '0.7rem', textAlign: 'right', opacity: 0.4 }}>{value}</span>
                </div>
              ))}
            </div>
            ...
            {c.typeDistribution && Object.keys(c.typeDistribution).length > 0 && (
              <div style={{ marginTop: '0.75rem' }}>
                <div style={{ fontSize: '0.7rem', textTransform: 'uppercase', opacity: 0.4, marginBottom: '0.3rem' }}>
                  Commit Types
                </div>

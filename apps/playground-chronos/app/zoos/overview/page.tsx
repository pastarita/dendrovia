...
export default async function OverviewPage() {
  ...
  const repo: RepositoryMetadata | null =
    topo?.repository && typeof topo.repository === 'object' ? (topo.repository as RepositoryMetadata) : null;
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {langDist.map((lang) => (
                <div key={lang.language} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  ...
                  <div
                    style={{ flex: 1, height: '20px', background: '#1a1a1a', borderRadius: '4px', overflow: 'hidden' }}
                  >
                    <div
                      style={{
            ...
            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
              <OrnateFrame pillar="chronos" variant="compact" style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: '1.3rem', fontWeight: 700, marginTop: '0.25rem' }}>
                  {contribSummary.totalContributors}
                </div>
              </OrnateFrame>
              <OrnateFrame pillar="chronos" variant="compact" style={{ flex: 2 }}>
                ...
                <div style={{ fontSize: '1.1rem', fontWeight: 600, marginTop: '0.25rem' }}>
                  {contribSummary.topContributor}
                </div>
              </OrnateFrame>
            </div>
            <h3 style={{ fontSize: '0.85rem', fontWeight: 600, opacity: 0.6, marginBottom: '0.5rem' }}>

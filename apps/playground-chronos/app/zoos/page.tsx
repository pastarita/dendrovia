...
const SECTIONS = [
  { name: "Overview", href: "/zoos/overview", icon: "📊", desc: "Repository metadata, language distribution, contributor summary" },
  { name: "Files", href: "/zoos/files", icon: "📂", desc: "Sortable file catalog with complexity badges and language tags" },
  ...
  { name: "Contract", href: "/zoos/contract", icon: "✅", desc: "Validate enriched contract fields exist and are well-formed" },
];

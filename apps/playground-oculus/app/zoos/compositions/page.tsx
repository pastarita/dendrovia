...
function CombatComposition() {
  useEffect(() => {
    ...
    s.startCombat(
      ...
      [
        { id: 's1', name: 'Git Blame', description: 'Trace origin', manaCost: 10, cooldown: 2, effect: { type: 'damage', target: 'enemy', value: 15 }, element: 'fire' },
        { id: 's2', name: 'Git Bisect', description: 'Binary search', manaCost: 20, cooldown: 3, effect: { type: 'damage', target: 'enemy', value: 30 }, element: 'air' },
      ]
    );
  ...
  return (
    <div>
      ...
      <p style={{ opacity: 0.5, marginBottom: '2rem' }}>
        Full HUD layouts showing how components compose together
      </p>
      <PlaygroundProvider>
        <CompositionsContent />
      </PlaygroundProvider>

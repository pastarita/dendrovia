...
const EXPECTED_EXPORTS = {
  ...
  persistence: {
    ...
    types: ['PersistenceConfig', 'MigrationFn', 'SaveSlot', 'GameStoreState', 'AutoSaveConfig', 'StateAdapterConfig'],
  },
  sync: {
...
const EVENTS_LISTENED = ['GameEvents.GAME_STARTED', 'GameEvents.LEVEL_LOADED'];
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <span style={{ fontSize: '0.85rem', opacity: 0.5 }}>{EXPECTED_SUBPATHS.length} subpaths</span>

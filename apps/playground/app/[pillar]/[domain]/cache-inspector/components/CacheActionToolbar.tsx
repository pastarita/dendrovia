...
const DEMO_ENTRIES = [
  { path: 'shaders/dendrite.glsl', data: '// dendrite vertex shader\nvoid main() { gl_Position = vec4(0.0); }', hash: 'abc123' },
  { path: 'shaders/bark.glsl', data: '// bark fragment shader\nvoid main() { gl_FragColor = vec4(0.5, 0.3, 0.1, 1.0); }', hash: 'def456' },
  { path: 'palettes/forest.json', data: '{"primary":"#2d5a27","secondary":"#8bc34a","accent":"#4caf50"}', hash: 'ghi789' },
...
export function CacheActionToolbar({
  ...
  return (
    <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
      ...
      <button onClick={handleEvict1h} style={btnStyle}>Evict &gt;1h</button>
      <button onClick={handleEvict24h} style={btnStyle}>Evict &gt;24h</button>

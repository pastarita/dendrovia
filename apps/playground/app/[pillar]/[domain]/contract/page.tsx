...
export default async function ContractPage() {
  ...
  if (topo) {
    ...
    checks.push({
      ...
      group: "Topology",
      pass: typeof topo.analyzedAt === "string" && !isNaN(Date.parse(topo.analyzedAt)),
  ...
  if (commits && commits.length > 0) {
    ...
    const validTypes = new Set([
      "bug-fix", "feature", "refactor", "docs", "test", "performance",
      "merge", "revert", "dependency", "breaking-change", "chore", "style", "maintenance",
    ]);

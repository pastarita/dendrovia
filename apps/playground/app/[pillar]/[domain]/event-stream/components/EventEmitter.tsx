    ...
    <div style={{ padding: "1rem 1.25rem", border: "1px solid #222", borderRadius: "8px" }}>
      ...
      <div style={{ display: "flex", gap: "0.75rem", alignItems: "flex-end", flexWrap: "wrap" }}>
        ...
        <div style={{ flex: 1, minWidth: "200px" }}>
          <label style={{ fontSize: "0.7rem", opacity: 0.5, display: "block", marginBottom: "0.25rem" }}>Payload (JSON)</label>
          <textarea
            value={payloadText}
      ...
      {status && (
        <div style={{ marginTop: "0.5rem", fontSize: "0.75rem", opacity: 0.5 }}>{status}</div>
      )}
    </div>
  );
}

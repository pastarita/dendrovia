/**
 * IMAGINARIUM Museum Gallery — Server component.
 *
 * Computes mycology specimens at build time using @dendrovia/imaginarium
 * functions, then passes them as props to the client component.
 */

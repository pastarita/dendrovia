  ...
  "dend-imaginarium->dend-architectus": {
    types: [
      ...
      },
      {
        ...
        source: "@dendrovia/shared",
        description:
          "Mycology catalog: fungal specimens mapped from code files.",
      ...
      },
      {
        ...
        source: "@dendrovia/shared",
        description:
          "Network graph of fungal connections between code modules.",
  ...
  "dend-architectus->dend-ludus": {
    types: [
      ...
      },
      {
        ...
        source: "@dendrovia/shared",
        description:
          "Snapshot of the 3D world state shared with game mechanics.",
        fields: [
          "entities",
          "spatialIndex",
          "playerPosition",

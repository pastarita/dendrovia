...
export const architectusFixture: SourceDiagram = {
  ...
  nodes: [
    ...
    // Phase: Load
    {
      ...
      status: 'implemented',
      domain: 'architectus',
      children: ['arch-asset-bridge'],
    },
    {
      id: 'arch-asset-bridge',
      label: 'AssetBridge',
      kind: 'section',
      status: 'implemented',
      domain: 'architectus',
      description: 'Loads distilled assets from IMAGINARIUM',
    },
    ...
    // Phase: Render
    {
      ...
      status: 'partial',
      domain: 'architectus',
      children: ['arch-dendrite-world', 'arch-camera', 'arch-lighting', 'arch-postfx', 'arch-perf', 'arch-gpu'],
    },
    {
      id: 'arch-dendrite-world',
      label: 'DendriteWorld',
      kind: 'section',
      status: 'partial',
      domain: 'architectus',
      description: 'Main 3D scene composition',
    },
    {
      id: 'arch-camera',
      label: 'CameraRig',
      ...
      status: 'implemented',
      domain: 'architectus',
      description: 'Orbit camera with constraints',
    },
    {
      id: 'arch-lighting',
      label: 'Lighting',
    ...
    },
    {
      ...
      status: 'scaffold',
      domain: 'architectus',
      description: 'Bloom, SSAO, tone mapping',
    },
    {
      id: 'arch-perf',
      ...
      status: 'implemented',
      domain: 'architectus',
      description: 'FPS and GPU timing',
    },
    {
      id: 'arch-gpu',
      label: 'detectGPU',
      ...
      status: 'implemented',
      domain: 'architectus',
      description: 'GPU capability detection',
    },
    ...
    // Phase: Instances
    {
      ...
      status: 'partial',
      domain: 'architectus',
      children: ['arch-branch-inst', 'arch-node-inst', 'arch-mushroom-inst'],
    },
    {
      id: 'arch-branch-inst',
      label: 'BranchInstances',
      kind: 'section',
      status: 'partial',
      domain: 'architectus',
      description: 'Instanced branch geometry',
    },
    {
      id: 'arch-node-inst',
      label: 'NodeInstances',
      ...
      status: 'partial',
      domain: 'architectus',
      description: 'Instanced node geometry',
    },
    {
      id: 'arch-mushroom-inst',
      label: 'MushroomInstances',
      kind: 'section',
      status: 'scaffold',
      domain: 'architectus',
      description: 'Instanced mushroom placement',
    },
    ...
    // Phase: Systems
    {
      ...
      status: 'implemented',
      domain: 'architectus',
      children: ['arch-lsystem', 'arch-turtle'],
    },
    {
      id: 'arch-lsystem',
      label: 'LSystem',
    ...
    },
    {
      ...
      status: 'implemented',
      domain: 'architectus',
      description: '3D turtle graphics interpreter',
    },
  ],
  edges: [

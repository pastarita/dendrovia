...
export const dendroviaFixture: SourceDiagram = {
  ...
  nodes: [
    ...
    // --- CHRONOS ---
    { id: "dend-chronos", label: "CHRONOS", kind: "phase", status: "implemented", domain: "chronos", children: ["dend-chr-parse", "dend-chr-analyze", "dend-chr-build", "dend-chr-classify"] },
    { id: "dend-chr-parse", label: "Parse", kind: "section", status: "implemented", domain: "chronos", description: "GitParser + ASTParser" },
    { id: "dend-chr-analyze", label: "Analyze", kind: "section", status: "implemented", domain: "chronos", description: "ComplexityAnalyzer + HotspotDetector" },
    { id: "dend-chr-build", label: "Build", kind: "section", status: "implemented", domain: "chronos", description: "TopologyBuilder + TreeBuilder + ContributorProfiler" },
    ...
    // --- ARCHITECTUS ---
    { id: "dend-architectus", label: "ARCHITECTUS", kind: "phase", status: "partial", domain: "architectus", children: ["dend-arc-load", "dend-arc-render", "dend-arc-instances", "dend-arc-systems"] },
    ...
    { id: "dend-lud-character", label: "Character", kind: "section", status: "implemented", domain: "ludus", description: "CharacterSystem" },
    { id: "dend-lud-combat", label: "Combat", kind: "section", status: "implemented", domain: "ludus", description: "TurnBased + CombatMath + EnemyAI + MonsterFactory + StatusEffects" },
    { id: "dend-lud-quest", label: "Quest", kind: "section", status: "implemented", domain: "ludus", description: "QuestGenerator + EncounterSystem" },
    { id: "dend-lud-progression", label: "Progression", kind: "section", status: "implemented", domain: "ludus", description: "ProgressionSystem + SpellFactory + Inventory" },
    { id: "dend-lud-simulation", label: "Simulation", kind: "section", status: "implemented", domain: "ludus", description: "Harness + GameStore + Events + Save + Balance + RNG" },

    // --- OCULUS ---
    { id: "dend-oculus", label: "OCULUS", kind: "phase", status: "implemented", domain: "oculus", children: ["dend-ocu-components", "dend-ocu-primitives", "dend-ocu-hooks", "dend-ocu-store"] },
    { id: "dend-ocu-components", label: "Components", kind: "section", status: "implemented", domain: "oculus", description: "HUD + BattleUI + CodeReader + Minimap + QuestLog + Billboard + Falcon + Miller" },
    { id: "dend-ocu-primitives", label: "Primitives", kind: "section", status: "implemented", domain: "oculus", description: "Panel + IconBadge + ProgressBar + StatLabel + Tooltip" },
    { id: "dend-ocu-hooks", label: "Hooks", kind: "section", status: "implemented", domain: "oculus", description: "useCodeLoader + useEventSubscriptions + useInputCapture + useKeyboardShortcuts" },
    { id: "dend-ocu-store", label: "Store", kind: "section", status: "implemented", domain: "oculus", description: "OculusProvider + useOculusStore" },

    // --- OPERATUS ---
    { id: "dend-operatus", label: "OPERATUS", kind: "phase", status: "implemented", domain: "operatus", children: ["dend-ops-cache", "dend-ops-loader", "dend-ops-manifest", "dend-ops-persist", "dend-ops-sync", "dend-ops-perf"] },
    { id: "dend-ops-cache", label: "Cache", kind: "section", status: "implemented", domain: "operatus", description: "CacheManager + IDB + OPFS" },
    { id: "dend-ops-loader", label: "Loader", kind: "section", status: "implemented", domain: "operatus", description: "AssetLoader + CDNLoader" },
    { id: "dend-ops-manifest", label: "Manifest", kind: "section", status: "implemented", domain: "operatus", description: "ManifestGenerator" },
    { id: "dend-ops-persist", label: "Persistence", kind: "section", status: "implemented", domain: "operatus", description: "StatePersistence + AutoSave + GameStore + StateAdapter" },
    { id: "dend-ops-sync", label: "Sync", kind: "section", status: "implemented", domain: "operatus", description: "CrossTabSync + MultiplayerClient + ServiceWorker" },
    { id: "dend-ops-perf", label: "Perf", kind: "section", status: "implemented", domain: "operatus", description: "PerfMonitor" },
  ],
  edges: [

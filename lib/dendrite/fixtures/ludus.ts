...
export const ludusFixture: SourceDiagram = {
  ...
  nodes: [
    ...
    // Phase: Character
    {
      ...
      status: 'implemented',
      domain: 'ludus',
      children: ['ludus-char-system'],
    },
    {
      id: 'ludus-char-system',
      label: 'CharacterSystem',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
    ...
    // Phase: Combat
    {
      ...
      status: 'implemented',
      domain: 'ludus',
      children: ['ludus-turn-engine', 'ludus-combat-math', 'ludus-enemy-ai', 'ludus-monster', 'ludus-status'],
    },
    {
      id: 'ludus-turn-engine',
      label: 'TurnBasedEngine',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
      description: 'Turn-based combat execution',
    },
    {
      id: 'ludus-combat-math',
      label: 'CombatMath',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
      description: 'Damage, defense, hit calculations',
    },
    {
      id: 'ludus-enemy-ai',
      label: 'EnemyAI',
      ...
      status: 'implemented',
      domain: 'ludus',
      description: 'AI decision-making for enemies',
    },
    {
      id: 'ludus-monster',
      label: 'MonsterFactory',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
      description: 'Procedural monster generation',
    },
    {
      id: 'ludus-status',
      label: 'StatusEffects',
      ...
      status: 'implemented',
      domain: 'ludus',
      description: 'Buff/debuff status effect system',
    },
    ...
    // Phase: Quest/Encounter
    {
      ...
      status: 'implemented',
      domain: 'ludus',
      children: ['ludus-quest-gen', 'ludus-encounter'],
    },
    {
      id: 'ludus-quest-gen',
      label: 'QuestGenerator',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
      description: 'Procedural quest generation from code metrics',
    },
    {
      id: 'ludus-encounter',
      label: 'EncounterSystem',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
      description: 'Random encounter management',
    },

    // Phase: Progression
    {
      id: 'ludus-progression',
      label: 'Progression',
      kind: 'phase',
      status: 'implemented',
      domain: 'ludus',
      children: ['ludus-prog-system', 'ludus-spells', 'ludus-inventory'],
    },
    {
      id: 'ludus-prog-system',
      label: 'ProgressionSystem',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
      description: 'XP, leveling, and skill trees',
    },
    {
      id: 'ludus-spells',
      label: 'SpellFactory',
      ...
      status: 'implemented',
      domain: 'ludus',
      description: 'Spell creation from code patterns',
    },
    {
      id: 'ludus-inventory',
    ...
    // Phase: Simulation
    {
      ...
      status: 'implemented',
      domain: 'ludus',
      children: ['ludus-harness', 'ludus-game-store', 'ludus-events', 'ludus-save', 'ludus-balance', 'ludus-rng'],
    },
    {
      id: 'ludus-harness',
      label: 'SimulationHarness',
      kind: 'section',
      status: 'implemented',
      domain: 'ludus',
      description: 'Headless game simulation runner',
    },
    {
      id: 'ludus-game-store',
      label: 'GameStore',
      ...
      status: 'implemented',
      domain: 'ludus',
      description: 'Central game state store',
    },
    {
      id: 'ludus-events',
      label: 'EventWiring',
      ...
      status: 'implemented',
      domain: 'ludus',
      description: 'Game event bus and wiring',
    },
    {
      id: 'ludus-save',
      label: 'SaveSystem',
    ...
    },
    {
      ...
      status: 'implemented',
      domain: 'ludus',
      description: 'Game balance parameters',
    },
    {
      id: 'ludus-rng',
      label: 'SeededRandom',

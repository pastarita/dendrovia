...
export const operatusFixture: SourceDiagram = {
  ...
  nodes: [
    ...
    // Phase: Cache
    {
      ...
      status: 'implemented',
      domain: 'operatus',
      children: ['op-cache-mgr', 'op-idb', 'op-opfs'],
    },
    {
      id: 'op-cache-mgr',
      label: 'CacheManager',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'Unified cache coordinator',
    },
    {
      id: 'op-idb',
      label: 'IDBCache',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'IndexedDB cache backend',
    },
    {
      id: 'op-opfs',
      label: 'OPFSCache',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'Origin Private File System cache',
    },
    ...
    // Phase: Loader
    {
      ...
      status: 'implemented',
      domain: 'operatus',
      children: ['op-asset-loader', 'op-cdn-loader'],
    },
    {
      id: 'op-asset-loader',
      label: 'AssetLoader',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'Progressive asset loading pipeline',
    },
    {
      id: 'op-cdn-loader',
      label: 'CDNLoader',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'CDN-backed asset fetching',
    },
    ...
    // Phase: Manifest
    {
      ...
      status: 'implemented',
      domain: 'operatus',
      children: ['op-manifest-gen', 'op-generate'],
    },
    {
      id: 'op-manifest-gen',
      label: 'ManifestGenerator',
      kind: 'section',
      status: 'implemented',
      domain: 'operatus',
      description: 'Build-time manifest generation',
    },
    {
      id: 'op-generate',
      label: 'generate',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'CLI generate command',
    },
    ...
    // Phase: Persistence
    {
      ...
      status: 'implemented',
      domain: 'operatus',
      children: ['op-state-persist', 'op-autosave', 'op-game-store', 'op-state-adapter'],
    },
    {
      id: 'op-state-persist',
      label: 'StatePersistence',
      kind: 'section',
      status: 'implemented',
      domain: 'operatus',
      description: 'State serialization/deserialization',
    },
    {
      id: 'op-autosave',
      label: 'AutoSave',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'Periodic auto-save system',
    },
    {
      id: 'op-game-store',
      label: 'GameStore',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'Operatus game state adapter',
    },
    {
      id: 'op-state-adapter',
      label: 'StateAdapter',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'Cross-pillar state adapter',
    },
    ...
    // Phase: Sync
    {
      ...
      status: 'implemented',
      domain: 'operatus',
      children: ['op-cross-tab', 'op-multiplayer', 'op-sw'],
    },
    {
      id: 'op-cross-tab',
      label: 'CrossTabSync',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'BroadcastChannel cross-tab sync',
    },
    {
      id: 'op-multiplayer',
      label: 'MultiplayerClient',
      kind: 'section',
      status: 'implemented',
      domain: 'operatus',
      description: 'WebSocket multiplayer client',
    },
    {
      id: 'op-sw',
      label: 'ServiceWorker',
      ...
      status: 'implemented',
      domain: 'operatus',
      description: 'Offline-first service worker',
    },

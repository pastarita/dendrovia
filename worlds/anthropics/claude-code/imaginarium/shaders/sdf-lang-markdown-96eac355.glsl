...
// Seed: 96eac3558dd3cfaec9fd486b0edff919e54ffc9c7394f175b6f0b818564a8fe2
// Variant: lang-markdown
// ============================================================
...
// --- Scene Definition ---
float scene(vec3 p) {
  // Noise: simplex, octaves=1, freq=1.5620689655172413
  // Displacement applied in applyLighting via surface normal

  float d = sdCapsule(p, vec3(0.0, 1.0, 0.0), vec3(0.0, 1.906, 0.423), 0.175);
  d = opSmoothUnion(d, sdCapsule(p, vec3(0.0, 1.0, 0.0), vec3(0.0, 1.906, -0.423), 0.175), 0.3);
  d = opSmoothUnion(d, sdCapsule(p, vec3(0.0, 1.0, 0.0), vec3(0.383, 1.821, 0.423), 0.175), 0.3);
  d = opSmoothUnion(d, sdCapsule(p, vec3(0.383, 1.821, 0.423), vec3(0.766, 2.643, 0.845), 0.175), 0.3);

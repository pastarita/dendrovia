...
// Seed: adf0d3f5f1ada968fdea732952a98a72d14ee9401d0699ea5283f70d3de298e3
// Variant: structural
// ============================================================
...
// --- Scene Definition ---
float scene(vec3 p) {
  // Noise: simplex, octaves=1, freq=1.7000000000000002
  // Displacement applied in applyLighting via surface normal

  float d = sdCapsule(p, vec3(0.0, 0.0, 0.0), vec3(0.0, 1.0, 0.0), 0.25);

...
// Seed: e81a3d86b40349773719be73e505695623686ef61f57a1689b3a818296b5278d
// Variant: lang-javascript
// ============================================================
...
// --- Scene Definition ---
float scene(vec3 p) {
  // Noise: fbm, octaves=4, freq=1.3470588235294119
  // Displacement applied in applyLighting via surface normal

  float d = sdCapsule(p, vec3(0.0, 1.0, 0.0), vec3(0.423, 1.906, 0.0), 0.175);
